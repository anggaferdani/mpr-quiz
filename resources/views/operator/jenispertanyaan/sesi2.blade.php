                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                <label for="exampleInputUsername1" class="fw-bold">Pernyataan<span
                                ...
                                <textarea class="form-control mt-2" name="pernyataan" rows="4"
                                          placeholder="Pernyataan anda.."></textarea>
                                @error('pernyataan')
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                ...
                                <div class="kontra-input d-flex justify-content-center items-align-center gap-4">
                                    <input type="text" class="form-control mt-2" value="" placeholder="Pointer pro..."
                                           name="pro[]" required>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                <label for="exampleInputUsername1" class="fw-bold">Pointer KONTRA<span
                                        class="text-danger">*</span></label>
                                <div class="kontra-input d-flex justify-content-center items-align-center gap-4">
                                    <input type="text" class="form-control mt-2" value=""
                                           placeholder="Pointer kontra..." name="kontra[]" required>
                    ...
                    <form action="{{ url('/op/sesi-2') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer gap-1">
                            <button type="button" class="btn btn-outline-warning btn-icon-text" data-bs-dismiss="modal"
                                    aria-label="Close">
                                Cancel
                            </button>
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <div class="team-selection d-flex gap-4">
                    @foreach($team as $item)
                        ...
                        <div class="form-check">
                            ...
                            @else
                                <input class="pernyataan-radios form-check-input id_tim" type="radio" name="idtim"
                                       data-team-name="{{$item->name}}" id="team{{$item->id}}" value="{{$item->id}}">
                            @endif
                ...
                <div class="d-flex gap-4">
                    <div class="form-check">
                        <input type="radio" class="pernyataan-radios form-check-input radio-sisi-sesi-2"
                               name="sisi_pernyataan" id="pro" value="pro">
                    ...
                    <div class="form-check">
                        <input type="radio" class="pernyataan-radios form-check-input radio-sisi-sesi-2"
                               name="sisi_pernyataan" id="kontra" value="kontra">
                                ...
                                <td class="">
                                    <div class="d-flex justify-content-center">
                                        <button type="button" data-bs-toggle="modal"
                                                data-bs-target="#pernyataan-{{ $pernyataan->id }}-modal"
                                                class="btn btn-primary btn-icon-text d-flex justify-conten" disabled
                                    ...
                                    <div class="modal fade" id="pernyataan-{{ $pernyataan->id }}-modal"
                                         data-modal-id="pernyataan-{{ $pernyataan->id }}-modal" tabindex="-1"
                                         aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Poin Poin -
                                                        <span class="textteam"></h1>
